...
const WhyItMatters = () => {
  ...
  const challenges = [
    'Academic pressure and college admission stress',
    ...
    'Fear of failure and future uncertainty',
    'Sexual abuse and relationship trauma',
    'Poverty and socioeconomic pressures',
    'Mental health stigma and lack of support'
  ];

  return (
    <section id="why-it-matters" className="py-20 bg-gradient-to-br from-green-50 via-purple-50 to-pink-50">
