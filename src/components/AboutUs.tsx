      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-amber-800 mb-6">
            About
            <span className="bg-gradient-to-r from-amber-600 to-orange-500 bg-clip-text text-transparent"> herMind space</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h3 className="text-2xl font-semibold text-amber-800 mb-6">Our Mission</h3>
          ...
          <Card className="bg-gradient-to-br from-amber-50 to-orange-50 border-0">
            <CardContent className="p-8">
              <div className="text-center">
                ...
                <h4 className="text-xl font-semibold text-amber-800 mb-4">Princess Mbamalu</h4>
                <p className="text-amber-700 mb-4">Founder & Visionary</p>
                <p className="text-sm text-amber-600 italic leading-relaxed">
